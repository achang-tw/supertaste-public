const SuperCoupon = {
		...
		async init(){
			...
			if(target){
				...
				var xpath = getXPath(targetElement);
		
				var element = document.evaluate(xpath, document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
				element.insertAdjacentHTML('afterend', await baseElement());
			}else{
				var xpath = getXPath('main');
				var element = document.evaluate(xpath, document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
				element.insertAdjacentHTML('beforebegin', await baseElement());
			}
